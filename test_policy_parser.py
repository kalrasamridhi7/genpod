...
def main():
    ...
    problem1 = parse_problem("domains/partially-observable-deterministic/colorballs/p2-1.pddl")
    #problem2 = parse_problem("domains/partially-observable-deterministic/colorballs/p3x3_no_pit.pddl")
