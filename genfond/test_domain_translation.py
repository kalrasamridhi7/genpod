...
def main():
    ...
    domain = parse_domain("domains/partially-observable-deterministic/ebtcs/d2.pddl")
    #domain = parse_domain("domains/partially-observable-deterministic/medpks/d.pddl")
    problem = parse_problem("domains/partially-observable-deterministic/ebtcs/p3_clogged.pddl")
    #problem = parse_problem("domains/partially-observable-deterministic/medpks/p10.pddl")
    hidden_predicates = parse_hidden_state_predicates(["domains/partially-observable-deterministic/ebtcs/p3_clogged_hidden.pddl"])
