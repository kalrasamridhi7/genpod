(define (problem loc09)
    ...
    (:init
        ...
        (not (at p2-2)) (not (at p3-2)) (not (at p4-2)) (not (at p5-2)) (not (at p6-2)) (not (at p7-2)) (not (at p8-2))
        (not (at p2-4)) (not (at p3-4)) (not (at p4-4)) (not (at p5-4)) (not (at p6-4)) (not (at p7-4)) (not (at p8-4))
        (not (at p2-6)) (not (at p3-6)) (not (at p4-6)) (not (at p5-6)) (not (at p6-6)) (not (at p7-6)) (not (at p8-6))
        (not (at p2-8)) (not (at p3-8)) (not (at p4-8)) (not (at p5-8)) (not (at p6-8)) (not (at p7-8)) (not (at p8-8))
