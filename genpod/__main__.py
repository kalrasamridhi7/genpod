...
from genpod.config_handler import DEFAULT_TYPE_CONFIGS, ConfigHandler
...
def main():
    ...
    for problem in problems:
        log.info(f"Problem {problem.name} has {len(problem.objects)} objects and {len(problem.init)} initial facts")
